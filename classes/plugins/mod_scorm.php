...
class mod_scorm {
    ...
    public static function settings($settings) {
        ...
        $settings->add(new \admin_setting_configselect(
            'local_recompletion/scorm',
            new lang_string('scormattempts', 'local_recompletion'),
            new lang_string('scormattempts_help', 'local_recompletion'),
            LOCAL_RECOMPLETION_NOTHING,
            $choices
        ));

        $settings->add(new \admin_setting_configcheckbox(
            'local_recompletion/archivescorm',
            new lang_string('archivescorm', 'local_recompletion'),
            '',
            1
        ));
    }
