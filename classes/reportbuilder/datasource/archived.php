...
use local_recompletion\reportbuilder\entities\archived as archived_entity;

/**
 * Archived record datasource.
 *
 ...
 */
class archived extends datasource {
    /**
    ...
    public static function get_name(): string {
        return get_string('datasource:local_recompletion_archived', 'local_recompletion');
    }
    ...
    protected function initialise(): void {
        $archivedentity = new archived_entity();
        $tablealias = $archivedentity->get_table_alias('local_recompletion_archived');
        $this->add_entity($archivedentity);

        $this->set_main_table('local_recompletion_archived', $tablealias);
