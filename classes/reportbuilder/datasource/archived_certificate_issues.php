...
/**
 * Mod_certificate archive datasource.
 *
...
class archived_certificate_issues extends datasource {
    ...
    public static function get_name(): string {
        return get_string('datasource:local_recompletion_cert', 'local_recompletion');
    }
    ...
    protected function initialise(): void {
        $certificates = new certificate_issues();
        $tablealias = $certificates->get_table_alias('local_recompletion_cert');
